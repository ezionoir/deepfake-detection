    ...
    def __init__(self, config=None):
        ...
        self.spa_tem_merge = nn.Sequential(
            nn.Conv3d(in_channels=3,
                      ...
                      stride=1,
                      padding=(1, 1, 1)),
            nn.BatchNorm3d(num_features=self.config['motion-diff']['features'][0]),
            nn.LeakyReLU(),
            nn.Conv3d(in_channels=self.config["motion-diff"]["features"][0],
                      ...
                      stride=1,
                      padding=(0, 1, 1)),
            nn.BatchNorm3d(num_features=self.config['motion-diff']['features'][1]),
            nn.LeakyReLU(),
            nn.Conv3d(in_channels=self.config["motion-diff"]["features"][1],
                      ...
                      stride=1,
                      padding=(0, 1, 1)),
            nn.BatchNorm3d(num_features=self.config['motion-diff']['features'][2]),
            nn.LeakyReLU()
        )
